...
const ICONS = {
  ...
  // مقابضُ إيقاع — وضعُ الدعم: يُعايِر ولا يبدّل منهجاً (حكم مدير اقرأ: الكفُّ تُقرأ «قف»)
  sliders: '<path d="M21 5H3M16 2.6v4.8"/>'
    + '<path d="M21 12H3M8 9.6v4.8"/>'
    + '<path d="M21 19H3M14 16.6v4.8"/>',
