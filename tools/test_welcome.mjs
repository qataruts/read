...
const INVENTORY = [
  ...
  ['الدليل: بطاقةُ أول تشغيل وحدودُها', 'guide.html',
    ['على رحلةٍ بكر', 'لا الامتحانَ رأساً', 'إلى الأبد بـ«لاحقاً» أو بأوّل نجمة',
      'ثبّته على الجهاز', 'ولا تدعو إلى الامتحان']],
  ...
  ['الدليل: الدعم — التلميحُ في أوّل لقاءٍ وحدَه', 'guide.html',
    ['تلميحٌ في أول لقاء', 'أوّل لقاءٍ بالمهارة وحدَه', 'لا في المراجعة ولا في الامتحانات']],
  ['الدليل: الدعم — مسطرةُ الامتحان الواحدة', 'guide.html',
    ['امتحانُ اللحاق بمسطرةٍ واحدة', 'أسهلَ من امتحان غيره']],
  ['الدليل: الدعم — مؤشّرُ الوضع على شاشة الطفل', 'guide.html',
    ['علامةٍ هادئة أعلى شاشة طفلك', 'تغيب حين تُطفئ الوضع']],
...
const COUNT_WORD = { 5: 'خمسةُ', 6: 'ستّةُ', 7: 'سبعةُ', 8: 'ثمانيةُ', 9: 'تسعةُ' };
