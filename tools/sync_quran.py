...
SURAHS = [
    ("s1", 1, 7), ("s112", 112, 4), ("s113", 113, 5), ("s114", 114, 6),
    # الشريحة الثانية (حزمة «القرآني الموسّع») — بترتيب الطول كما أقرّه المدير
    ("s108", 108, 3), ("s103", 103, 3), ("s106", 106, 4), ("s111", 111, 5),
    ("s105", 105, 5), ("s94", 94, 8), ("s107", 107, 7), ("s101", 101, 11),
]
...
RASM_WORDS = [
    ...
    ("ۦ", "106:2", 0),        # إِۦلَـٰفِهِمْ — الياء الصغيرة (أختها)
    ("ۢ", "112:4", -1),       # أَحَدٌۢ — الميم الصغيرة
    ("ۭ", "105:5", -1),       # مَّأْكُولٍۭ — الميم الصغيرة تحت الحرف
    ("۟", "103:3", 2),        # ءَامَنُوا۟ — الدائرة الصغيرة
]
